  ...
  return (
    <div className="min-h-screen bg-[#F7F6F2] flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        ...
        <h1 className="font-serif font-normal text-2xl text-[#0E1411] mb-2">
          Cross-checking 9 regulations…
        </h1>
        <p className="text-sm text-[#6B766F]">
          Your Readiness Card will be ready in about 5 minutes. Engine coming soon.
        </p>
      </div>
    </div>
  );
