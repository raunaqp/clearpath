...
function buildUserMessage(sources: SourceData): string {
  ...
  return [
    "Generate the body of Section 5 (Product Specification & Variants) for a CDSCO MD-7/MD-3 Draft Pack.",
    "Phrasing variety: open with 'As documented in MDR 2017 Fourth Schedule Appendix II' OR 'Per CDSCO published guidance on device master file structure'. Do not repeat openers from Sections 2-4.",
    "",
    "## Applicant data",
    ...
    "```",
    "{",
    '  "device_family": "≤ 60 words. Default: \\"Single product, single SKU within scope of this application. Model variants and accessories are not declared.\\" If pitch data suggests family/variants, describe — but do NOT invent SKU numbers.",',
    '  "physical_specifications": "80-180 words for hardware; one-paragraph N/A for software-only. Bound to source data — leave [TBD] for any specific dimension/weight/material not in source.",',
    '  "performance_specifications": "80-180 words. Functional spec — what the device does, accuracy/sensitivity/latency targets where supported by source. For AI/ML cite the IEEE/clinical paper if pitch references one. [TBD] otherwise.",',
    '  "intended_lifetime": "30-100 words. Hardware: expected service life (e.g., 5 years) — [TBD] if no source. Software: ongoing SDLC + IEC 62304 version-retirement framing."',
    "}",
    "```",
    "",
