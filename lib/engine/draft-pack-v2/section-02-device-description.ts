...
function buildUserMessage(sources: SourceData): string {
  ...
  return [
    "Generate the body of Section 2 (Device Description) for a CDSCO MD-7/MD-3 Draft Pack.",
    "Phrasing variety: open with 'Per MDR 2017 Schedule II and the IMDRF SaMD framework' OR 'In accordance with MDR 2017 Fourth Schedule Appendix II'. Avoid the phrase 'Based on published CDSCO guidance' here (used in Section 4).",
    "",
    "## Applicant data",
    ...
    "```",
    "{",
    '  "components_architecture": "60-180 words. Describe the physical/logical components, interfaces, modules. For software: front-end, back-end, ML model, data pipeline. For hardware: the constituent parts and how they fit together.",',
    '  "principle_of_operation": "60-180 words. How the device works to deliver its intended use. Must mention the intended user (HCP or patient) OR use environment (the one stated above) at least once. For AI/ML: state whether adaptive or static.",',
    '  "materials_standards": "60-180 words for hardware; one-sentence N/A statement for software-only. Reference applicable ISO/IEC standards where appropriate (ISO 10993 family for patient-contact; IEC 60601 for active medical electrical equipment).",',
    '  "variants_accessories": "60-180 words. Describe model variants and accessories. If none in source data, render \\"[TBD] — single variant assumed pending Sprint 3 family-grouping question.\\"",',
    '  "lifecycle_disposal": "60-180 words. Expected service life (hardware) or SDLC + version retirement (software). Disposal framing for physical products."',
    "}",
    "```",
    "",
